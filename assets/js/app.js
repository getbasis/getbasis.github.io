...
var BasisDrawer = function () {
  ...
  createClass(BasisDrawer, [{
    ...
    value: function setListener() {
      ...
      var btns = jquery('[data-c="drawer-btn"][aria-controls]');
      btns.each(function (i, e) {
        var btn = jquery(e);
        var drawer = jquery('#' + btn.attr('aria-controls'));
      ...
      var toggleBtns = jquery('[data-c="drawer__toggle"][aria-controls]');
    ...
    value: function setIdForSubmenu() {
      jquery('[data-c="drawer__submenu"][aria-hidden]').each(function (i, e) {
...
var BasisNavbar = function () {
  function BasisNavbar() {
    ...
    this.items = jquery('[data-c="navbar__item"][aria-haspopup="true"], [data-c="navbar__subitem"][aria-haspopup="true"]');
    this.setListener();
  }
...
var BasisPageEffect = function () {
  function BasisPageEffect(params) {
    ...
    this.container = jquery('[data-c="page-effect"]');
...
var BasisSelect = function BasisSelect() {
  ...
  this.select = jquery('[data-c="select"]');
...
var BasisFixedHeader = function () {
  function BasisFixedHeader() {
    ...
    this.container = jquery('[data-l="container"]');
    this.header = jquery('[data-l="header"]');
    this.windowScroll = jquery('html').attr('data-window-scroll');
  ...
  createClass(BasisFixedHeader, [{
    ...
    value: function setHeaderWidth() {
      var scrollbarWidth = jquery('body').innerWidth() - this.container[0].clientWidth;
      if (scrollbarWidth > 0) {
...
var BasisStickyHeader = function () {
  function BasisStickyHeader() {
    ...
    this.container = jquery('[data-l="container"]');
    this.header = jquery('[data-l="header"]');
    this.contents = jquery('[data-l="contents"]');
    this.windowScroll = jquery('html').attr('data-window-scroll');
  ...
  createClass(BasisStickyHeader, [{
    ...
    value: function setScroll() {
      ...
      if (scroll > 0) {
        jquery('html').attr('data-scrolled', 'true');
      } else {
        jquery('html').attr('data-scrolled', 'false');
      }
    }
  }, {
    key: 'setSticky',
